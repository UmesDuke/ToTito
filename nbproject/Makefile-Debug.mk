...
${OBJECTDIR}/c/arraylist.o: c/arraylist.c
	${MKDIR} -p ${OBJECTDIR}/c
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c/arraylist.o c/arraylist.c

${OBJECTDIR}/c/graphics.o: c/graphics.c
	${MKDIR} -p ${OBJECTDIR}/c
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c/graphics.o c/graphics.c

${OBJECTDIR}/c/utils.o: c/utils.c
	${MKDIR} -p ${OBJECTDIR}/c
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c/utils.o c/utils.c
...
${OBJECTDIR}/unix/lnxutils.o: unix/lnxutils.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/unix/lnxutils.o unix/lnxutils.c

${OBJECTDIR}/win/winutils.o: win/winutils.c
	${MKDIR} -p ${OBJECTDIR}/win
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/win/winutils.o win/winutils.c
